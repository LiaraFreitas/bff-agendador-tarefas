...
public class UsuarioController {
    ...
    @PutMapping
    @Operation(summary = "Atualiza Dados de Usuários", description = "Atualizar Dados de Usuarios")
    ...
    @Operation(summary = "Atualiza Endereços de Usuários",
            description = "Atualiza endereços de usuário")
    ...
    @PutMapping("/telefone")
    @Operation(summary = "Atualiza Telefones de Usuários",
    ...
    @Operation(summary = "Salva Telefones de Usuários",
    ...
    @Operation(summary = "Busca endereço por CEP",
            description = "Busca dados de endereco buscando um CEP")
